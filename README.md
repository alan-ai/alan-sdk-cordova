# The Self-Coding System for Your App &mdash; Alan AI SDK for Cordova
...
This repository contains the **Alan AI SDK for Cordova**, enabling you to embed Alan's intelligent layer into your Android applications.

## How to start

To create an AI agent for your Apache Cordova app:
...
2. Use the Alan AI SDK for Cordova to embed an AI agent to your app. For details, see <a href="https://alan.app/docs/client-api/cross-platform/cordova" target="_blank">Alan AI documentation</a>.
