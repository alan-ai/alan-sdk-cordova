...
To create an AI assistant or AI chat for your Apache Cordova app:
...
2. Use the Alan AI SDK for Cordova to embed an AI assistant or AI chat to your app. For details, see <a href="https://alan.app/docs/client-api/cross-platform/cordova" target="_blank">Alan AI documentation</a>.
