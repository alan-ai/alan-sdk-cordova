# Alan AI: In-app voice assistant SDK for Cordova
...
To create a voice assistant for your Apache Cordova app:
...
2. Use the Alan Cordova SDK to embed a voice assistant to your application. For details, see <a href="https://alan.app/docs/client-api/cross-platform/cordova" target="_blank">Alan AI documentation</a>.
